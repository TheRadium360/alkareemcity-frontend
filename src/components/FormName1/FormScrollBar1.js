...
const FormScrollBar1 = () => {
    return (
        ...
        <div className='row'>
          ...
          {/* -------Checkboxes-----------       */}
    <div className='foreign_transfer'>Foreign Transfer</div>

  <div className="form-check form1_checkbox">
  <input className="form-check-input chekbox_inputs" type="checkbox" value="" id="flexCheckDefault" />
  <label className="form-check-label " htmlFor="flexCheckDefault" > Purchaser Abroad
  </label>
</div>

  <div className="form-check form1_checkbox1">
  <input className="form-check-input chekbox_inputs" type="checkbox" value="" id="flexCheckDefault" />
  <label className="form-check-label " htmlFor="flexCheckDefault" > Seller Abroad
  </label>
</div>

<div className="form-check form1_checkbox2">
  <input className="form-check-input chekbox_inputs" type="checkbox" value="" id="flexCheckDefault" />
  <label className="form-check-label " htmlFor="flexCheckDefault" >Transfer on court Orders     
</label>
...
<div className='input_handle'>
    <div className='form_date'><input type="text" id="fname" name="fname" placeholder='Membership No' className='formall_inputs'/></div>
<div className='form_so'><input type="text" id="fname" name="fname" placeholder='Phase' className='formall_inputs'/></div>

<div className='form_cnic'><input type="text" id="fname" name="fname" placeholder='Sector' className='formall_inputs'/></div>
<div className='form_contact'><input type="text" id="fname" name="fname" placeholder='Measuring' className='formall_inputs'/></div>
</div>
